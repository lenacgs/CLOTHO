...
public class Rules {
	...
	public List<BoolExpr> return_conditions_rw_then(FuncDecl t1, FuncDecl t2, Expr vo1, Expr vo2, Expr vt1, Expr vt2,
		...
		System.out.println(t1.getName().toString());
		System.out.println("t2.getName().toString()");
		System.out.println(t2.getName().toString());
		
		if ((t1.getName().toString().split("_", 0)[0].equals("cluster") && 
			!t1.getName().toString().split("_", 0)[1].equals(t2.getName().toString().split("_", 0)[1])) || 
			!t1.getName().toString().split("_", 0)[0].equals("cluster")) {

			System.out.println("______________ANALYZING______________");
